...
__Report contents__ : `r input$inReport`
...
```{r kinsc1, results='asis', echo=FALSE}
if ('KIN' %in% input$inReport) {
  cat('## Chemical scheme and initial parameters values')
}
```

```{r kinsc2, results='asis', comment='',echo=FALSE}
if ('KIN' %in% input$inReport) {
  cat(paste(Scheme$scheme, collapse = '\n\n')) 
}
```

```{r kinop1, results='asis', echo=FALSE}
if ('KIN' %in% input$inReport) {
  cat('## Optimization')
}
```

```{r kinop2, results='markup', comment='', echo=FALSE}
if ('KIN' %in% input$inReport) {
...
```{r kinopt, results = 'asis', echo=FALSE}
if ('KIN' %in% input$inReport) {
  if (!is.null(kinOut <- doKin())) {
...
```{r kin2, results='asis', echo=FALSE}
if('KIN' %in% input$inReport){
  cat ('## Spectra and Kinetics')
}
```
...
```{r kin4, results='asis', echo=FALSE}
if('KIN' %in% input$inReport){
  cat ('## Residuals')
}
```
...
```{r kin6, results='asis', echo=FALSE}
if('KIN' %in% input$inReport){
...
```{r kin8, results='asis', echo=FALSE}
if('KIN' %in% input$inReport){
  cat ('## L.o.f. vs. SVD')
}
```
